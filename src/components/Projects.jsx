...
<h1 className="text-4xl md:text-6xl font-medium tracking-tight mb-10">Our Team</h1>
    ...
    {PROJECTS.map((project, index) => (
        ...
        variants={projectVariants}>
            ...
            <div className="flex flex-col justify-between">
                ...
                <a className="bg-white text-stone-900 rounded-full py-2 w-32 text-sm hover:bg-gray-100 text-center" href={project.link} target="_blank" rel="noopener norefferer">View on Instagram</a>
            </div>
            </div>
